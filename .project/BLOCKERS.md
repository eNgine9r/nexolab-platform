...
Issue #965 has a review candidate at `1ec18502ff3bbcbd710da240a2875a991886d3c8` on `feat/965-sensor-placement-quick-add`. No repository dependency blocker remains. Local focused verification is GREEN (14/14 placement/domain tests, targeted ESLint/Prettier and whitespace checks); merge remains gated on exact-head GitHub typecheck/build, Refrigeration Browser acceptance and clean review. This is a verification gate, not a product blocker. K96–K100 remain hardware-unverified and excluded from automatic production polling. #189/#585 remain blocked, #201 remains `needs_validation`, and #202 remains `hardware_validation`.
