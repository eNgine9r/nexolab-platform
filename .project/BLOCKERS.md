...
Issue #965 is active again on `feat/965-sensor-placement-quick-add`. The reliability interrupt is cleared and no repository dependency blocker remains for #965. K96–K100 remain hardware-unverified and excluded from automatic production polling. #189/#585 remain blocked, #201 remains `needs_validation`, and #202 remains `hardware_validation`.
