...
| N-025 | Capacity alert thresholds | Metrics implemented; policy pending | Establish production thresholds from host capacity/throughput evidence; do not hide or auto-delete terminal/pending records |
