...
Issue #965 review fix is at `755ea1bde77ca5b84dd5adb83965935e820e24ac` on `feat/965-sensor-placement-quick-add`. PR #992 had a fully GREEN exact-head matrix at `286be2e84645fb9c5d300803cd9b6f54ed48bcdb`, but two additional late review findings correctly reopened the verification gate. Both are addressed locally: rename changes now remain staged before any global save and Escape restores the original label, while late climate-catalog/channel metadata refresh no longer rehydrates or overwrites an active staged layout draft. Focused verification is GREEN at 26/26 plus targeted ESLint/Prettier/whitespace checks. Merge remains gated on fresh exact-head GitHub typecheck/build, Refrigeration Browser acceptance and clean review. This is a verification gate, not a product blocker. K96–K100 remain hardware-unverified and excluded from automatic production polling. #189/#585 remain blocked, #201 remains `needs_validation`, and #202 remains `hardware_validation`.
