...
Issue #849 reconciles these facts into canonical state. After #849 exact-head state CI and merge, **stop for separate explicit Product Owner approval** before any Stage-2 production/site cutover. Approval is not implied by prior manual actions. No controlled deployment, migration, report send, schedule enablement, Modbus/hardware write or destructive data/volume operation may occur before that approval.
