...
## Sprint execution gate — RFX-06 / Issue #947 active

RFX-05 / #943 is completed and merged through PR #946 with exact verified head `5f7ac8de85c601f9d57ce4d219f520c62c246685`, all 12 routed exact-head workflows GREEN, Telemetry PostgreSQL/full suite GREEN, Authenticated Dashboard/Offline Bundle/Capacity Release Gate GREEN and NEXOLAB Merge Gate GREEN. The Product Owner no-Codex decision makes manual Team Lead exact-head review plus exact-head CI authoritative; manual review was clean with zero unresolved threads. RFX-06 / #947 is the active product package from `main` `95d1266c77309bffa037cf2b2af33c1156e3705c` and depends on completed #943. Issue #717 is the authority for the newer RFX Work Package numbering; ADR 0010 remains architecture/safety authority. #189/#585 remain blocked, #201 remains `needs_validation`, and #202 remains `hardware_validation`.
...
## RFX-06 / Issue #947 — active; no software blocker

RFX-05 closed all software gates on exact head `5f7ac8de85c601f9d57ce4d219f520c62c246685`: Telemetry Service `34019638916`, Core CI / NEXOLAB Merge Gate `34019638884`, Offline Bundle `34019638885`, Authenticated Dashboard `34019638863` and Capacity Release Gate `34019638941` are GREEN; manual Team Lead review was clean with zero unresolved threads. RFX-06 / #947 is active for Refrigeration Circuit, versioned refrigerant/configuration history and semantic Signal→role Binding only. Local PostgreSQL verification is GREEN: migration head/round-trip, direct-SQL guards, historical handover/retirement semantics and the 120-pass compatibility matrix succeeded. Exact-head GitHub CI and manual Team Lead review are still required before merge. Existing cabinet placement/controller bindings remain separate. Property-provider adoption, derived thermodynamics, live polling, deployment, Modbus/hardware writes and hardware acceptance are not authorized.
