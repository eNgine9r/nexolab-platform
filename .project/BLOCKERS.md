...
Issue #965 review fix is at `c4fabe1817708bb496f19bb1bdd22eac19beb2e3` on `feat/965-sensor-placement-quick-add`. PR #992 exact head `13f43a171ea0ad61e9f7e536e40afbe2e90e193c` passed the full required matrix, but one additional late P2 correctly reopened the verification gate because `communication_error` rendered as a generic sensor error instead of `Offline`. The quality classifier now handles offline/communication before generic error states, with focused verification GREEN at 27/27 plus targeted ESLint/Prettier/whitespace checks. All previous rename/draft-hydration/freshness/capacity/snap findings remain addressed. Merge remains gated on fresh exact-head GitHub typecheck/build, Refrigeration Browser acceptance and clean late review. This is a verification gate, not a product blocker. K96–K100 remain hardware-unverified and excluded from automatic production polling. #189/#585 remain blocked, #201 remains `needs_validation`, and #202 remains `hardware_validation`.
