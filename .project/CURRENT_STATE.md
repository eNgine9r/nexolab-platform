...
Issue #433 is implemented and locally verified on branch
`fix/433-sensor-enrollment-recovery`; exact-head GitHub workflow verification
and focused PR review are pending.
