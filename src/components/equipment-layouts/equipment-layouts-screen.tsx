    ...
    <main className="grid min-h-screen place-items-center bg-[#06142a] p-4 text-slate-100">
      <section className="w-full max-w-lg rounded-3xl border border-cyan-400/15 bg-[#091a31]/95 p-6 shadow-2xl shadow-black/30">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs tracking-[0.2em] text-cyan-300 uppercase">NEXOLAB Layout Gate</p>
...
export function EquipmentLayoutsScreen() {
  ...
  if (security.mode === "demo") {
    return (
      <EquipmentLayoutsModeGate
        title="Каталог схем доступний лише в live mode"
        message="Сторінка навмисно не підміняє відсутні equipment/layout API демонстраційними схемами. Налаштуйте локальний Telemetry Service і NEXT_PUBLIC_NEXOLAB_DATA_MODE=live."
      />
    );
  }
  ...
  if (!security.membership) {
    return (
      <EquipmentLayoutsModeGate
        ...
        message="Для каталогу схем потрібне активне membership. Equipment і layout запити не виконувалися."
