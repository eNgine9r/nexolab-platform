...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["last_scan_id"], ["equipment_discovery_scans.id"], name="fk_equipment_discovery_candidates_last_scan", ondelete="RESTRICT"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["source_candidate_id"], ["equipment_discovery_candidates.id"], name="fk_equipment_network_assets_candidate", ondelete="RESTRICT"),
        sa.PrimaryKeyConstraint("id"),
