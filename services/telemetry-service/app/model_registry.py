...
def register_models() -> None:
    ...
    from app.auth.immutability import register_platform_audit_immutability
    ...
    register_platform_audit_immutability()
    ...
    assert _auth_models.PlatformAuditEvent.__tablename__ == "platform_audit_events"
